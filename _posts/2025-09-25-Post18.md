...
In this post, we continue take a look at **A4. Homoskedasticity & No AutoCorrelation** condition. We know that this assumption is critical in determining that the OLS estimator is BLUE - Best Linear Unbiased estimator. As we did for heteroskedasticity in the [previosus post](https://jkang918.github.io/posts/Post17/), in this post, I will try to go through statistical tests to detect autocorrelation and the corresponding remedial methods.
